...
const {doc_renderer, make_toc, require_attribute} = require('../util')
...
class DocBuilder {
    ...
    */
    ...
    _read_conf() {
        ...
        require_attribute(conf, ['name', 'organization', 'tags'])
        assert(conf.tags.length > 0, `"tags" must contains at least an item`)
