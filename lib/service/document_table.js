...
class DocumentTable {
    ...
    */
    ...
    async list(conf) {
        ...
        let offset = (new_conf.page - 1) * DocumentTable.PAGE_SIZE
        let pattern = this._get_search_pattern(new_conf.keyword)
        let params = [pattern, pattern, DocumentTable.PAGE_SIZE, offset]
    ...
    async _get_num_page(keyword) {
        ...
        return Math.ceil(count / DocumentTable.PAGE_SIZE)
    }
